...
class PaperPile:
    ...
    def forkable_roll_count(self, max_neighbors=3):
        forkable_roll_count = 0
        ...
        for y in range(len(self.rows)):
            for x in range(self.row_len):
                ...
                if neighbor_rolls <= max_neighbors:
                    ...
                    forkable_roll_count += 1

        return forkable_roll_count
...
def main(args):
    ...
    forkable_roll_count = paper_pile.forkable_roll_count()
    print(paper_pile)
    print(f"Forkable rolls: {forkable_roll_count}")
